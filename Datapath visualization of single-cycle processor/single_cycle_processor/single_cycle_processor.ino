...
void bus2muxA2down(int r, int g, int b)
{
...
void pcPlus4down(int r, int g, int b){line(17, 54, 15, 54, r, g, b);}
void muxA1down(int r, int g, int b){line(37, 28, 36, 28, r, g, b); }
void pcPlus8up(int r, int g, int b){ line(38, 42, 36, 42, r, g, b);}
void initialSetup()
{
  //Control Unit
    ctrlUnit(0,15,0);
    ...
    pcPlus4down(0,15,0); //(PC + 4) ALU down input
    ...
    muxA1down(0,15,0);//MUX A1 down
    
  
   
    bus2muxA2up(0,15,0); //Bus 2 MUX A2 up
    bus2muxA2down(0,15,0);
   ...
   //PC+8 ALU
    pcPlus8alu(0,15,0); //(PC + 😎 ALU
    pcPlus8alu2reg(0,15,0); //ALU to Register file
    pcPlus8up(0,15,0); //ALU input up
    pcPlus42pcPlus8(0,15,0); //(PC + 😎 ALU input down connected to (PC + 4) ALU
...
void str()
{
  ...
  muxA12reg(15,0,0);
  muxA22reg(15,0,0);
  immsrc2extend(15,0,0);
  extend(15,0,0);
  reg(15,0,0);
  delay(4000);
  muxA12reg(0,15,0);
  muxA22reg(0,15,0);
  immsrc2extend(0,15,0);
  muxA1(0,15,0);
  muxA2(0,15,0);
  bus2reg(0,15,0);
...
void mov()
{
  ...
  //Step8
  alub4dataMem2muxAfterDataMem(15,0,0);
  mem2reg(15,0,0);
...
void B()
{
    ...
    clk2instMem(15,0,0);
    instMem(15,0,0);
    clk2PCplus4Alu(15,0,0);
    PCplus4Alu(15,0,0);
    pcPlus4down(15,0,0);
    delay(4000);
    clk2instMem(0,15,0);
    clk2PCplus4Alu(0,15,0);
    pcPlus4down(0,15,0);
    
   
    instMem2bus(15,0,0);
    bus(15,0,0);
    pcPlus42pcPlus8(15,0,0);
    pcPlus8alu(15,0,0);
    pcPlus8up(15,0,0);
    delay(4000);
    instMem2bus(0,15,0);
    instMem(0,15,0);
    pcPlus42pcPlus8(0,15,0);
    PCplus4Alu(0,15,0);
    pcPlus8up(0,15,0);
